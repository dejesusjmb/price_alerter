...
class Alert(object):
    ...
    def send(self):
        alert_url = 'http://pricing.dejesusjmb.com/alerts/{}'.format(self._id)
        text = ('We have found a deal! ({}). '
                'To navigate to the alert, visit {}').format(self.item.url, alert_url)
    ...
    def find_by_user_email(cls, user_email):
        return [cls(**elem) for elem in
                Database.find(AlertConstants.COLLECTION,  {'user_email': user_email})]
